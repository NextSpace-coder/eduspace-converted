                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="hero-content">
                            <span className="wow fadeInUp">Welcome to Learning Platform</span>
                            <h1 className="wow fadeInUp" data-wow-delay=".3s">
                                Modern Education
                                Excellence in
                                Online Learning
                            </h1>
                            <h3 className="wow fadeInUp" data-wow-delay=".5s">Discover thousands of quality courses for your professional growth</h3>
